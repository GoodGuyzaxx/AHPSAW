    ...
    <main class="container-fluid px-4 animate-fade-in">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <p class="mb-0 text-muted">Tambahkan kriteria baru untuk digunakan dalam penilaian.</p>
            </div>
        </div>
                ...
                <div class="card border-0 shadow-sm animate-fade-in" style="animation-delay: 0.1s">
                    <div class="card-header bg-gradient-info text-white border-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-0 fw-bold">Formulir Tambah Kriteria</h5>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('kriteria.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" autofocus required placeholder="Contoh: Penghasilan Orang Tua">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" value="{{ old('keterangan') }}" required placeholder="Contoh: Semakin rendah, semakin baik">
                            ...
                            <li>
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 small text-muted">Semakin tinggi nilai, semakin rendah peluang untuk dipilih.</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
