    ...
    <main class="container-fluid px-4 animate-fade-in">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <p class="mb-0 text-muted">Tambahkan data mahasiswa baru ke dalam sistem.</p>
            </div>
        </div>
                ...
                <div class="card border-0 shadow-sm animate-fade-in" style="animation-delay: 0.1s">
                    <div class="card-header bg-gradient-info text-white border-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-0 fw-bold">Formulir Tambah Mahasiswa</h5>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('student.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('npm') is-invalid @enderror" id="npm" name="npm" value="{{ old('npm') }}" autofocus required placeholder="Masukkan Nomor Pokok Mahasiswa">
                                <small class="text-muted mt-1 d-block">NPM harus unik dan terdiri dari angka.</small>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex pt-2">
                                    <div class="form-check form-check-inline me-4">
                                        <input class="form-check-input" type="radio" name="gender" id="gender_laki" value="Laki-laki" {{ old('gender') == 'Laki-laki' ? 'checked' : '' }} required>
                                        <label class="form-check-label" for="gender_laki">Laki-laki</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="gender_perempuan" value="Perempuan" {{ old('gender') == 'Perempuan' ? 'checked' : '' }} required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nomor_hp') is-invalid @enderror" id="nomor_hp" name="nomor_hp" value="{{ old('nomor_hp') }}" required placeholder="Contoh: 081234567890">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" required placeholder="Contoh: mahasiswa@example.com">
