...
@section('content')
    ...
    <section id="hero-animated" class="hero-animated d-flex align-items-center">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative"
            data-aos="zoom-out">
            <img src="{{ url('frontend/images/Sekolah.png') }}" class="img-fluid animated" />
            <h2>Selamat datang di</h2>
            <p>Sistem Pendukung Keputusan Penuntun Penerima Beasiswa Kurang Mampu</p>
            <!-- <div class="d-flex">
                @auth
            ...
            <div class="container" data-aos="fade-up">
                <div class="section-header">
                    ...
                    <p>
                        ...
                        solusi inovatif dalam pemilihan penerima beasiswa kurang mampu menggunakan
                        Sistem Pendukung Keputusan (SPK). Kami berkomitmen untuk membantu
                        sekolah, lembaga pendidikan, dan pihak terkait dalam proses
                        seleksi penerima beasiswa kurang mampu yang adil, obyektif, dan efisien.
                    </p>
                </div>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                ...
                                <p>
                                    Penggunaan website untuk pemilihan penerima beasiswa kurang mampu dengan
