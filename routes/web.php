...
use App\Http\Controllers\Admin\CriteriaSubController;
...
Route::prefix('dashboard')
    ...
    ->group(function () {
        ...
        Route::resources([
            ...
            'subkriteria'  => CriteriaSubController::class,
        ...
        Route::get('ranking/export/{criteria_analysis}', [RankingController::class, 'export'])
            ->name('rank.export');
        Route::get('/export-saw/{criteriaAnalysis}', [RankingController::class, 'exportToExcel'])
            ->name('export.saw');
    });
